...
extension APITestCases: APICallCenterDelegate {
    ...
    func getRecipesDidFinish(recipes: [Reciplease.RecipeAPI], nextPage: Reciplease.Next?) {
    ...
    func getNextPageDidFinish(recipes: [Reciplease.RecipeAPI], nextPage: Reciplease.Next?) {
...
extension APITestCases {
    private func controlRecipes(result: [Reciplease.RecipeAPI]) {
